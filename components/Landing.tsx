      ...
      <div className="relative">
        <div className=" relative mx-auto px-4 ">
          <div className="mx-auto grid max-w-160 grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-5">
            ...
            <div className="relative lg:col-span-3 max-w-[1600px] max-h-[1180px]">
              <div className="relative aspect-753/582 w-full">
                <Image
                  src="/banner.png"
                  alt="Banner"
                  fill
                  className="object-fit relative z-20 -mb-36 rounded-xl bg-slate-200 shadow-xl shadow-black/5 ring-1 ring-slate-900/5 sm:-mb-16 lg:-mb-8 xl:-mb-16"
                />
              </div>
            </div>
          </div>
